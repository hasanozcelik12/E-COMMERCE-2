...
import { addToBasket, reduceToBasket } from '../redux/reducers/actions/productActions'
  ...
  return (
    <div className="d-flex gap-4 justify-content-between p-4 shadow my-5">
      ...
      <div className="d-flex gap-3 align-items-center">
        ...
        <button onClick={() => dispatch(reduceToBasket(item))} className="btn btn-danger">-</button>
        <button
